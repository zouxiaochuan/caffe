#ifndef CAFFE_EXSIGMOIDCROSSENTROPY_LOSS_LAYER_HPP_
#define CAFFE_EXSIGMOIDCROSSENTROPY_LOSS_LAYER_HPP_
...
class ExSigmoidCrossEntropyLossLayer : public LossLayer<Dtype> {
 public:
  explicit ExSigmoidCrossEntropyLossLayer(const LayerParameter& param)
  ...
  virtual inline const char* type() const { return "ExSigmoidCrossEntropyLoss"; }

 protected:
  /// @copydoc ExSigmoidCrossEntropyLossLayer
...
#endif  // CAFFE_EXSIGMOIDCROSSENTROPY_LOSS_LAYER_HPP_
